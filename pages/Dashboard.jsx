...
const Dashboard = () => {
  ...
  if (status === "authenticated")
    return (
      <>
        <div
          className={` sm:h-screen   w-full flex font-Montserrat p-5 bg-[#F5F5F5] ${opacity ? "blur-sm opacity-70 h-[600px]":"h-[1300px]"}`}
        >
          <div
            id="sidebard"
            className="h-full sm:w-1/5 w-2/3 sm:flex hidden "
          >
            <Sidebar />
          </div>
          <div
